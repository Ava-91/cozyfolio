      ...
      <div className="container max-w-6xl">
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-3">
            <span className="text-xs font-semibold uppercase tracking-[0.25em] text-primary">Featured work</span>
            <div className="h-px flex-1 bg-border" />
          </div>

          <div className="grid grid-cols-1 gap-6">
            {featuredProjects.map((project, index) => renderProject(project, index, true))}
          </div>

          {otherProjects.length > 0 && (
            <>
              <div className="flex items-center gap-3 pt-8">
                <span className="text-xs font-semibold uppercase tracking-[0.25em] text-muted">More things I&apos;ve built</span>
                <div className="h-px flex-1 bg-border" />
              </div>
