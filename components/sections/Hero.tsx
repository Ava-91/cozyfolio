      ...
      <FadeIn>
        <div className="mx-auto w-full max-w-4xl text-center">
          ...
          <div className="mt-9 flex flex-col justify-center gap-3 sm:mt-12 sm:flex-row sm:flex-wrap sm:gap-4">
            <Link href="#projects" className="w-full sm:w-auto"><Button variant="primary" size="lg" fullWidth>View Projects</Button></Link>
            <Link href="#about" className="w-full sm:w-auto"><Button variant="ghost" size="lg" fullWidth>About Me</Button></Link>
          </div>
